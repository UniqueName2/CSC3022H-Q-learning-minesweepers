...
void CController::PlotStats(HDC surface)
{
	...
	s = "Total MinesGathered last round: " + ftos((m_vecTotalMinesGathered.size() > 0) ? m_vecTotalMinesGathered[m_vecTotalMinesGathered.size() - 1] : 0.0);
